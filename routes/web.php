...
// The callback url after a payment Redo Pay
Route::get('redo-payment', 'RedoController@payment')->name('redo-payment');
Route::any('redo-response', 'RedoController@callback')->name('redo-response');
