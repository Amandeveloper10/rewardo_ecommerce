                ...
                <!-- Payment methods accordion-->
                    ...
                    <div class="row g-3">
						...
						<div class="col-sm-6">
							<div class="card cursor-pointer">
								<div class="card-body __h-100px">
									<form action="{{route('redo-payment')}}" method="get" class="needs-validation">
										<input type="hidden" name="payment_method" value="redo_pay">
										<input type="hidden" name="api_key" value="{{env('APP_MODE')=='demo'?'':$config['login_id']}}">
										<button class="btn btn-block click-if-alone" type="submit">
											<img width="150" class="__mt-n-10"
												 src="{{url('https://www.vectorlogo.zone/logos/upi/upi-ar21.png')}}"/>
										</button>
									</form>
								</div>
							</div>
