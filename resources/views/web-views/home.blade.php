                                        ...
                                        <span class="d-inline-block font-size-sm text-body">
                                            @for($inc=0;$inc<5;$inc++)
                                                @if($inc<$overallRating[0])
                                                    <i class="p-0 666 sr-star czi-star-filled active"></i>
                                                @else
                                                    <i class="p-0 666 sr-star czi-star __color-fea569"></i>
                                                @endif
                                            @endfor
                                ...
                                <div class="__i-1">
                                    <div class="text-left __p-20px">
                                        ...
                                        <div class="rating-show">
                                            ...
                                            <span class="d-none font-size-sm text-body">
                                                @for($inc=0;$inc<5;$inc++)
                                                    @if($inc<$overallRating[0])
                    ...
                    <div class="card-body p-xl-35">
                        ...
                        <div>
                            @foreach($bestSellProduct as $key=>$bestSell)
								...
								onclick="location.href='{{route('product',$bestSell->product->slug)}}'">
								<i class="czi-eye align-middle {{Session::get('direction') === "rtl" ? 'ml-1' : 'mr-1'}}"></i>
								{{\App\CPU\translate('Buy')}}   {{\App\CPU\translate('Now')}}
							</button>
                                            </div>
                                        </div>
                                    </a>
